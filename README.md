...
9. ✅ submission API
10. ✅ sandbox runner (hardened: cpu-pin on Linux/quota fallback on Docker Desktop, ro-rootfs, caps dropped, NetworkPolicy; Go builds end-to-end, Rust/binary via Dockerfile templates)
